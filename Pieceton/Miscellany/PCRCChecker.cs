...
{
    public static class PCRCChecker
    {
        public static UInt32 GetCRC(byte[] data) { return UpdateCRC32(data); }

        [SecurityCritical, SecurityTreatAsSafe]
        private static UInt32 UpdateCRC32(byte[] data)
        {
            UInt32 oldCrc = Crc32StartValue;
